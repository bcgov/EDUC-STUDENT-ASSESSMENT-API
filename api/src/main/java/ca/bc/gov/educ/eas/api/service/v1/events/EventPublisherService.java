...
public class EventPublisherService {
  ...
  public void send(final Event event) throws JsonProcessingException {
    if (event.getReplyTo() != null) {
      ...
      this.getMessagePublisher().dispatchMessage(event.getReplyTo(), this.easEventProcessed(event));
    }
  }

  private byte[] easEventProcessed(final Event easEvent) throws JsonProcessingException {
