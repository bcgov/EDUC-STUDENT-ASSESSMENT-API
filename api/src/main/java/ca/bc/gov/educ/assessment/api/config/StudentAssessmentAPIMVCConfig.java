 ...
 */
@Configuration
public class StudentAssessmentAPIMVCConfig implements WebMvcConfigurer {
   ...
   */
  @Autowired
  public StudentAssessmentAPIMVCConfig(final RequestResponseInterceptor requestResponseInterceptor) {
