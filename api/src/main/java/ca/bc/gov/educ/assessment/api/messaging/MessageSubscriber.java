package ca.bc.gov.educ.assessment.api.messaging;
...
import static ca.bc.gov.educ.assessment.api.constants.TopicsEnum.STUDENT_ASSESSMENT_API_TOPIC;
...
public class MessageSubscriber {
    ...
    public void subscribe() {
        String queue = STUDENT_ASSESSMENT_API_TOPIC.toString().replace("_", "-");
        var dispatcher = connection.createDispatcher(onMessage());
        dispatcher.subscribe(STUDENT_ASSESSMENT_API_TOPIC.toString(), queue);
    }
