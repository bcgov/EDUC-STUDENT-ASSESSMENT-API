...
import ca.bc.gov.educ.eas.api.exception.InvalidParameterException;
import ca.bc.gov.educ.eas.api.filter.BaseFilterSpecs;
import ca.bc.gov.educ.eas.api.filter.FilterOperation;
import ca.bc.gov.educ.eas.api.struct.v1.Condition;
import ca.bc.gov.educ.eas.api.struct.v1.Search;
import ca.bc.gov.educ.eas.api.struct.v1.SearchCriteria;
import ca.bc.gov.educ.eas.api.struct.v1.ValueType;
