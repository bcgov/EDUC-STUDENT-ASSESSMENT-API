...
public enum EventOutcome {
  ...
  MYED_NOTIFIED,
  COMPLETION_DATE_SET,
  GRAD_FLAGS_FLIPPED_FOR_STUDENTS,
  SAGA_COMPLETED,
  ...
  STAGED_STUDENT_DOAR_CALCULATED,
  DELETED_STUDENT_FROM_STAGING,
  DELETE_PEN_ISSUE_STUDENTS_FROM_STAGING_COMPLETED,
  FIND_STUDENT_IN_GRAD_OR_ADOPT_COMPLETED
}
