package ca.bc.gov.educ.assessment.api.health;
...
@Component
@Slf4j
public class AssessmentAPICustomHealthCheck implements HealthIndicator {
  private final Connection natsConnection;

  public AssessmentAPICustomHealthCheck(final Connection natsConnection) {
