...
(
    ...
    CONSTRAINT STAGED_ASSESSMENT_STUDENT_COMPONENT_SUB_TYPE_FK FOREIGN KEY (COMPONENT_SUB_TYPE_CODE) REFERENCES COMPONENT_SUB_TYPE_CODE (COMPONENT_SUB_TYPE_CODE),
    CONSTRAINT STAGED_ASSESSMENT_STUDENT_COMPONENT_TYPE_FK FOREIGN KEY (COMPONENT_TYPE_CODE) REFERENCES COMPONENT_TYPE_CODE (COMPONENT_TYPE_CODE),
