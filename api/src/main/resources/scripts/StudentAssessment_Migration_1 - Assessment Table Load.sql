...
VALUES (LOWER(REGEXP_REPLACE(dbms_crypto.randombytes(16), '(.{8})(.{4})(.{4})(.{4})(.{12})', '\1-\2-\3-\4-\5')),
        ...
        'ASSESSMENT-API', SYSDATE,'ASSESSMENT-API',SYSDATE, to_date('2018-02-28 00:00:00','YYYY-MM-DD HH24:MI:SS'));
...
VALUES (LOWER(REGEXP_REPLACE(dbms_crypto.randombytes(16), '(.{8})(.{4})(.{4})(.{4})(.{12})', '\1-\2-\3-\4-\5')),
        ...
        'ASSESSMENT-API', SYSDATE,'ASSESSMENT-API',SYSDATEto_date('2018-04-30 00:00:00','YYYY-MM-DD HH24:MI:SS'));
