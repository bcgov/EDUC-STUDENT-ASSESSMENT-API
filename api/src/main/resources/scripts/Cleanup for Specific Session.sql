delete from assessment_student_doar_calculation doar
    using assessment assess
where doar.assessment_id = assess.assessment_id
...
delete from staged_assessment_student_doar_calculation;
delete from staged_assessment_student_answer;
delete from staged_assessment_student_choice_question_set;
