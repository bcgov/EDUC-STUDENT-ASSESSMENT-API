...
EMAIL_TEMPLATE_MYED_APPROVAL_NOTIFICATION="<!DOCTYPE html><html xmlns:th=\"http://www.thymeleaf.org\"><head><meta charset=\"ISO-8859-1\"><title>Session Assessment Results are available</title></head><body><br><br>Test <span th:text=\"\${$}{currentSession}\"></span>. Test<br><br>Regards,<br>The Ministry of Education and ChildCare's EDX Team</body></html>"
