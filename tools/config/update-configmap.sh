...
SCHEDULED_JOBS_TRANSFER_STAGED_STUDENTS_CRON="0/2 * * * * *"
SCHEDULED_JOBS_TRANSFER_STAGED_STUDENTS_CRON_LOCK_AT_LEAST_FOR="1700ms"
SCHEDULED_JOBS_TRANSFER_STAGED_STUDENTS_CRON_LOCK_AT_MOST_FOR="1900ms"
